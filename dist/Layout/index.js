...
var px = prop_types_1.default.oneOfType([
...
exports.propTypes = {
  ...
  shrink: prop_types_1.default.oneOfType([
    prop_types_1.default.bool,
    prop_types_1.default.number
  ]),
  grow: prop_types_1.default.oneOfType([
    prop_types_1.default.bool,
    prop_types_1.default.number
  ]),
...
var getPropsWithLayout = function (props, defaultProps) {
  var fullProps = defaultProps
    ? __assign(__assign({}, defaultProps), props)
    : props
...
var Layout = function (InputComponent, defaultProps) {
  ...
  out.propTypes = InputComponent.propTypes
    ? __assign(__assign({}, InputComponent.propTypes), exports.propTypes)
    : exports.propTypes // TODO FIX ME
  return out
}
